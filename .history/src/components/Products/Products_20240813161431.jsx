...
const Products = () => {
  return (
    <>
      ...
      <article>
        <h3>Software</h3>
        <img src="/public/Image/Software.jpg" alt="" width={500} />
        <p>
      ...
      <article>
        <h3>Firewall</h3>
        <img src="/public/Image/Firewall.jpg" alt="" width={500} />
        <p>
      ...
      <article>
        ...
        <img src="/public/Image/Antivirus.png" alt="" width={500} />
        <p>
      ...
      <article>
        <h3>VPN Services</h3>
        <img src="/public/Image/VPN.jpg" alt="" width={500} />
        <p>
