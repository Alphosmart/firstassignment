...
const Products = () => {
  return (
    <>
      ...
      <article>
        <h3>Software</h3>
        <img src="/public/Image/Software.jpeg" alt="" width={500} />
        <p>
      ...
      <article>
        <h3>Firewall</h3>
        <img src="/public/Image/Firewall.jpeg" alt="" width={500} />
        <p>
      ...
      <article>
        ...
        <img src="/public/Image/Antivirus.jpeg" alt="" width={500} />
        <p>
      ...
      <article>
        <h3>VPN Services</h3>
        <img src="/public/Image/VPN.jpeg" alt="" width={500} />
        <p>
      ...
      <article>
        <h3>Cloud Storage</h3>
        <img src="/public/Image/Cloud.jpeg" alt="" width={500} />
        <p>
          Store and access your data from anywhere with our secure and scalable
          cloud storage solutions.
        </p>
      </article>
      <article>
        <h3>Cyber Security Experts</h3>
        <img src="/public/Image/CyberGhost.jpeg" alt="" width={500} />
        <p>
