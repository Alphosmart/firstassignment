  ...
  return (
    <>
      <div className="partners">
        ...
        <article>
          <h2>Microsoft</h2>
          <img src="/public/Image/Microsoft.jpeg" alt="" width={500} />
          <p>
        ...
        <article>
          <h2>Google</h2>
          <img src="/public/Image/Google.png" alt="" width={500} />
          <p>
        ...
        <article>
          <h2>Amazon</h2>
          <img src="/public/Image/Amazon.png" alt="" width={500} />
          <p>
        ...
        <article>
          <h2>IBM</h2>
          <img src="/public/Image/IBM.png" alt="" width={500} />
          <p>
